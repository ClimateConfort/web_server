...
public class UserController 
{
	...
	public String userIkusiEraikinak(Model model, Principal principal, @AuthenticationPrincipal UserDetails userDetails) 
	{
    ...
    public String userParametroaAldatu(@Valid @ModelAttribute("parametro") int parametro, Model model, Principal principal) 
    {   
